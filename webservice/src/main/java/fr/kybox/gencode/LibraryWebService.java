 ...
 * 2018-11-22T14:02:25.652+01:00
 * Generated source version: 3.2.4
 *
 */
@WebServiceClient(name = "LibraryWebService",
                  wsdlLocation = "http://kybox.fr/kylibrary/test/wsdl/LibraryService.wsdl",
...
public class LibraryWebService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://kybox.fr/kylibrary/test/wsdl/LibraryService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(LibraryWebService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://kybox.fr/kylibrary/test/wsdl/LibraryService.wsdl");
        }
        WSDL_LOCATION = url;
    }
